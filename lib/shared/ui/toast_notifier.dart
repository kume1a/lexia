...
final class ToastNotifier {
  void warning({LocalizedStringResolver? title, required LocalizedStringResolver description}) {
    return _notify(title: title, description: description, type: ToastificationType.warning);
  }

  void error({LocalizedStringResolver? title, required LocalizedStringResolver description}) {
    return _notify(title: title, description: description, type: ToastificationType.error);
  }

  void success({LocalizedStringResolver? title, required LocalizedStringResolver description}) {
    return _notify(title: title, description: description, type: ToastificationType.success);
  }

  void info({LocalizedStringResolver? title, required LocalizedStringResolver description}) {
