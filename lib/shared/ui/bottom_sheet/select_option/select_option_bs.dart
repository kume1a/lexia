...
class SelectOptionSelectorBS<T extends Object?> extends StatelessWidget {
  const SelectOptionSelectorBS({super.key, required this.header, required this.options});
    ...
    return Material(
      ...
      child: SafeArea(
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(maxHeight: mediaQuery.size.height * .6),
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  header(l),
                  style: TextStyle(fontSize: 13, color: theme.appThemeExtension?.elSecondary),
                ),
              ),
